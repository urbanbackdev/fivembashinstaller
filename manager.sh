...
echo Making directories under /home/fivem/server
mkdir /home/fivem/server-data
chmod 777 -R /home/fivem/
cd server-data || exit
git clone https://github.com/citizenfx/cfx-server-data.git
sudo mv  -v ~/fivem/server-data/cfx-server-data/resources /home/fivem/server-data/
sudo rm -r /home/fivem/server-data/cfx-server-data/
...
sv_hostname HierDEinFIveMNameEInfügen
# Nested configs!
...
sv_licenseKey HierDeinFiveMKeyEinfügen" > server.cfg

#CHMOD THE RUN FILE SO IT CAN BE EXECUTED
chmod 777 /home/fivem/run.sh

#SHOW TIME BABY ENJOY
#echo Starting FiveM Server...
#cd /home/fivem/server-data/ || exit

#bash /home/fivem/run.sh +exec server.cfg

echo Server wurde erstellt! :D